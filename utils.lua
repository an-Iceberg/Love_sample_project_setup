...
utils.clamp = function (min, max, number)
...
utils.is_point_in_circle = function(point_x, point_y, circle_x, circle_y, circle_radius)
  return math.abs(((circle_x - point_x)^2 + (circle_y - point_y)^2)) <= circle_radius^2
end

-- Returns true if the point is in or on the rectangle
utils.is_point_in_rectangle = function(point_x, point_y, rectangle_top_left_x, rectangle_top_left_y, rectangle_width, rectangle_height)
  if
